  ...
  return (
    <div className='bg-background-80 p-3 rounded-xl w-full'>
        ...
        <p className='text-text-secondary'>
                {type === 'COMMENT' ? 
                'If the user comments on a video that is setup to listen for keywords,this automation will be fire' 
                :
                'If the user send your a message that contains a keywords, this automation will be fire' 
            ...
            <div className='flex gap-2 mt-5 flex-wrap'>
                {keywords.map((word)=>(
                    <div key={word.id} className='bg-gradient-to-br from-[#3352cc] to-[#1c2d70] flex items-center
